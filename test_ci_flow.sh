...
# Check if there are actual changes after staging
if git diff --cached --quiet; then
    echo -e "${YELLOW}⚠️  No changes detected from bug introduction. Forcing a trivial change...${NC}"
    echo "# CI test run at $(date)" >> src/calculator.py
    git add src/calculator.py
fi
