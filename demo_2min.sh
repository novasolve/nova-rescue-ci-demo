...
phase2_cli_demo() {
    ...
    python -m pytest tests/test_calculator.py -v -p no:pytest_httpbin 2>/dev/null || pytest tests/test_calculator.py -v -p no:pytest_httpbin
    ...
    # Show failing tests
    print_cmd "pytest tests/test_calculator.py -v -p no:pytest_httpbin"
    python -m pytest tests/test_calculator.py -v -p no:pytest_httpbin 2>/dev/null || pytest tests/test_calculator.py -v -p no:pytest_httpbin || true
